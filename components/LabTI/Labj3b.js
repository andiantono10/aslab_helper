...
export default class Labj3b extends Component {
    render() {
        return (
            <ImageBackground source={require('../../assets/back3.png')} style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
                <Content>
                    <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
                        <Text style={{ fontSize: 20, fontWeight: 'bold', color: 'white' }}>Jadwal Praktikum Lab J3B</Text>
                        <Image source={require('./gambar/J3B.png')} style={{ width: 355, height: 300, resizeMode: 'contain' }} />
                        <View style={{ flex: 1, backgroundColor: 'skyblue', width: 350, height: 170, borderRadius: 15 }}>
                            <Text style={{ marginLeft: 10, marginRight: 10, marginTop: 5 }}>Untuk Membuka Kunci Ruangan Lab. J3 Ruang B :</Text>
